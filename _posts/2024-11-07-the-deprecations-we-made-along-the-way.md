...
[https://support.esri.com/en-us/knowledge-base/deprecation-map-viewer-classic-deprecation-000030662](https://support.esri.com/en-us/knowledge-base/deprecation-map-viewer-classic-deprecation-000030662)
...
[![the four panel anakin and padme meme, where padme repeats herself in the second and fourth panels, the text now reads: panel1 Anakin: you need to convert all of your web map viewer classics to the new web map viewer; panel 2 Padme: that should be something we can filter against or see visually right?; panel 3 Anakin staring: no text; panel 4 Padme: that should be something we can filter against or see visually right?](/img/posts/2024-11-07-meme-that-should-be-something.png)](/img/posts/2024-11-07-meme-that-should-be-something.png)
...
[!["a screen shot within ArcGIS Online showing three map viewers with different underlying properties. they all look the same](/img/posts/2024-11-07-ago.snippet-01.png)](/img/posts/2024-11-07-ago.snippet-01.png)
...
[!["Dataframe showing that Web Map items are different depending on how they were created, with Web Map Viewer new or classic.](/img/posts/2024-11-07-dataframe-snippet.png)](/img/posts/2024-11-07-dataframe-snippet.png)
...
[https://developers.arcgis.com/python/latest/guide/working-with-different-authentication-schemes/](https://developers.arcgis.com/python/latest/guide/working-with-different-authentication-schemes/)
...
[!["a screen shot of the entire python script as seen from a jupyter notebook within VSCode](/img/posts/2024-11-07-python-code-sample.png)](/img/posts/2024-11-07-python-code-sample.png)
